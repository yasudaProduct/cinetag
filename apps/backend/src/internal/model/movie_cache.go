...
type MovieCache struct {
	...
	ProductionCountries datatypes.JSON `gorm:"type:jsonb;column:production_countries" json:"production_countries,omitempty"`
	Credits             datatypes.JSON `gorm:"type:jsonb" json:"credits,omitempty"`
